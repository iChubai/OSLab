...
exit(int error_code) {
  ...
  800072:	46250513          	addi	a0,a0,1122 # 8004d0 <main+0xe>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800134:	3b878793          	addi	a5,a5,952 # 8004e8 <main+0x26>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018c:	460a8a93          	addi	s5,s5,1120 # 8005e8 <main+0x126>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ae:	39678793          	addi	a5,a5,918 # 800740 <error_string>
  ...
  8003c2:	16260613          	addi	a2,a2,354 # 800520 <main+0x5e>
  ...
  8003d4:	14060613          	addi	a2,a2,320 # 800510 <main+0x4e>
  ...
  800446:	0bfd8d93          	addi	s11,s11,191 # 800501 <main+0x3f>
  ...
  800482:	08250513          	addi	a0,a0,130 # 800500 <main+0x3e>
  ...
  800496:	06ed8d93          	addi	s11,s11,110 # 800500 <main+0x3e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  8004c6:	e406                	sd	ra,8(sp)
    exit(0);
  8004c8:	b9fff0ef          	jal	800066 <exit>
