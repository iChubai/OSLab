...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	5ba50513          	addi	a0,a0,1466 # 8005e8 <main+0xc4>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800042:	e41a                	sd	t1,8(sp)
    cprintf("user panic at %s:%d:\n    ", file, line);
  800044:	0b8000ef          	jal	8000fc <cprintf>
    vcprintf(fmt, ap);
  800048:	65a2                	ld	a1,8(sp)
  80004a:	8522                	mv	a0,s0
  80004c:	090000ef          	jal	8000dc <vcprintf>
    cprintf("\n");
  800050:	00000517          	auipc	a0,0x0
  800054:	5b850513          	addi	a0,a0,1464 # 800608 <main+0xe4>
  800058:	0a4000ef          	jal	8000fc <cprintf>
    va_end(ap);
    exit(-E_PANIC);
  80005c:	5559                	li	a0,-10
  80005e:	04a000ef          	jal	8000a8 <exit>
...
exit(int error_code) {
  ...
  8000aa:	e406                	sd	ra,8(sp)
    sys_exit(error_code);
  8000ac:	ff1ff0ef          	jal	80009c <sys_exit>
    cprintf("BUG: exit failed.\n");
  8000b0:	00000517          	auipc	a0,0x0
  8000b4:	56050513          	addi	a0,a0,1376 # 800610 <main+0xec>
  8000b8:	044000ef          	jal	8000fc <cprintf>
    while (1);
...
00000000008000be <_start>:
    ...
    call umain
  8000be:	072000ef          	jal	800130 <umain>
1:  j 1b
...
cputch(int c, int *cnt) {
  8000c4:	1101                	addi	sp,sp,-32
  8000c6:	ec06                	sd	ra,24(sp)
  8000c8:	e42e                	sd	a1,8(sp)
    sys_putc(c);
  8000ca:	fd9ff0ef          	jal	8000a2 <sys_putc>
    (*cnt) ++;
  8000ce:	65a2                	ld	a1,8(sp)
}
  8000d0:	60e2                	ld	ra,24(sp)
    (*cnt) ++;
  8000d2:	419c                	lw	a5,0(a1)
  8000d4:	2785                	addiw	a5,a5,1
  8000d6:	c19c                	sw	a5,0(a1)
}
  8000d8:	6105                	addi	sp,sp,32
  8000da:	8082                	ret
...
vcprintf(const char *fmt, va_list ap) {
  ...
  8000e6:	fe250513          	addi	a0,a0,-30 # 8000c4 <cputch>
...
vcprintf(const char *fmt, va_list ap) {
  ...
  8000ee:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
  8000f0:	0ce000ef          	jal	8001be <vprintfmt>
    return cnt;
}
...
cprintf(const char *fmt, ...) {
  ...
  800122:	e41a                	sd	t1,8(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
  800124:	09a000ef          	jal	8001be <vprintfmt>
...
umain(void) {
  ...
  800134:	3f0000ef          	jal	800524 <main>
    exit(ret);
  800138:	f71ff0ef          	jal	8000a8 <exit>
...
strnlen(const char *s, size_t len) {
  ...
  80013c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
  80013e:	e589                	bnez	a1,800148 <strnlen+0xc>
  800140:	a811                	j	800154 <strnlen+0x18>
        cnt ++;
  800142:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
  800144:	00f58863          	beq	a1,a5,800154 <strnlen+0x18>
  800148:	00f50733          	add	a4,a0,a5
  80014c:	00074703          	lbu	a4,0(a4)
  800150:	fb6d                	bnez	a4,800142 <strnlen+0x6>
  800152:	85be                	mv	a1,a5
    }
    return cnt;
}
  800154:	852e                	mv	a0,a1
  800156:	8082                	ret
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800196:	49678793          	addi	a5,a5,1174 # 800628 <main+0x104>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	60aa8a93          	addi	s5,s5,1546 # 8007f4 <main+0x2d0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800410:	54478793          	addi	a5,a5,1348 # 800950 <error_string>
  ...
  800424:	23860613          	addi	a2,a2,568 # 800658 <main+0x134>
  ...
  800436:	21660613          	addi	a2,a2,534 # 800648 <main+0x124>
  ...
  8004e4:	16050513          	addi	a0,a0,352 # 800640 <main+0x11c>
  8004e8:	c55ff0ef          	jal	80013c <strnlen>
  8004ec:	40ad0d3b          	subw	s10,s10,a0
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  8004f0:	02800793          	li	a5,40
                p = "(null)";
  8004f4:	00000d97          	auipc	s11,0x0
  8004f8:	14cd8d93          	addi	s11,s11,332 # 800640 <main+0x11c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  80052a:	1fa50513          	addi	a0,a0,506 # 800720 <main+0x1fc>
main(void) {
  80052e:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800530:	bcdff0ef          	jal	8000fc <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800534:	00001597          	auipc	a1,0x1
  800538:	acc58593          	addi	a1,a1,-1332 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  80053c:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  80053e:	4681                	li	a3,0
  800540:	00100637          	lui	a2,0x100
  800544:	a029                	j	80054e <main+0x2a>
  800546:	2685                	addiw	a3,a3,1
  800548:	0791                	addi	a5,a5,4
  80054a:	00c68f63          	beq	a3,a2,800568 <main+0x44>
        if (bigarray[i] != 0) {
  80054e:	4398                	lw	a4,0(a5)
  800550:	db7d                	beqz	a4,800546 <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  800552:	00000617          	auipc	a2,0x0
  800556:	1ee60613          	addi	a2,a2,494 # 800740 <main+0x21c>
  80055a:	45b9                	li	a1,14
  80055c:	00000517          	auipc	a0,0x0
  800560:	20450513          	addi	a0,a0,516 # 800760 <main+0x23c>
  800564:	abdff0ef          	jal	800020 <__panic>
  800568:	00001717          	auipc	a4,0x1
  80056c:	a9870713          	addi	a4,a4,-1384 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800570:	4781                	li	a5,0
  800572:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  800576:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  800578:	2785                	addiw	a5,a5,1
  80057a:	0711                	addi	a4,a4,4
  80057c:	fed79de3          	bne	a5,a3,800576 <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800580:	4681                	li	a3,0
  800582:	00100737          	lui	a4,0x100
  800586:	a029                	j	800590 <main+0x6c>
  800588:	2685                	addiw	a3,a3,1 # 100001 <__panic-0x70001f>
  80058a:	0591                	addi	a1,a1,4
  80058c:	02e68063          	beq	a3,a4,8005ac <main+0x88>
        if (bigarray[i] != i) {
  800590:	419c                	lw	a5,0(a1)
  800592:	fed78be3          	beq	a5,a3,800588 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  800596:	00000617          	auipc	a2,0x0
  80059a:	1da60613          	addi	a2,a2,474 # 800770 <main+0x24c>
  80059e:	45d9                	li	a1,22
  8005a0:	00000517          	auipc	a0,0x0
  8005a4:	1c050513          	addi	a0,a0,448 # 800760 <main+0x23c>
  8005a8:	a79ff0ef          	jal	800020 <__panic>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  8005ac:	00000517          	auipc	a0,0x0
  8005b0:	1ec50513          	addi	a0,a0,492 # 800798 <main+0x274>
  8005b4:	b49ff0ef          	jal	8000fc <cprintf>
    cprintf("testbss may pass.\n");
  8005b8:	00000517          	auipc	a0,0x0
  8005bc:	21850513          	addi	a0,a0,536 # 8007d0 <main+0x2ac>
  8005c0:	b3dff0ef          	jal	8000fc <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
    // asm volatile ("int $0x14");
    panic("FAIL: T.T\n");
  8005c4:	00000617          	auipc	a2,0x0
  8005c8:	22460613          	addi	a2,a2,548 # 8007e8 <main+0x2c4>
  8005cc:	45fd                	li	a1,31
  8005ce:	00000517          	auipc	a0,0x0
  8005d2:	19250513          	addi	a0,a0,402 # 800760 <main+0x23c>
    bigarray[ARRAYSIZE + 1024] = 0;
