...
exit(int error_code) {
  ...
  80007a:	48a50513          	addi	a0,a0,1162 # 800500 <main+0x32>
...
cputch(int c, int *cnt) {
  ...
  800092:	e42e                	sd	a1,8(sp)
    sys_putc(c);
  800094:	fd1ff0ef          	jal	800064 <sys_putc>
    (*cnt) ++;
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800140:	3dc78793          	addi	a5,a5,988 # 800518 <main+0x4a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800198:	4aca8a93          	addi	s5,s5,1196 # 800640 <main+0x172>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ba:	3e278793          	addi	a5,a5,994 # 800798 <error_string>
  ...
  8003ce:	18660613          	addi	a2,a2,390 # 800550 <main+0x82>
  ...
  8003e0:	16460613          	addi	a2,a2,356 # 800540 <main+0x72>
  ...
  800452:	0e3d8d93          	addi	s11,s11,227 # 800531 <main+0x63>
  ...
  80048e:	0a650513          	addi	a0,a0,166 # 800530 <main+0x62>
  ...
  8004a2:	092d8d93          	addi	s11,s11,146 # 800530 <main+0x62>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
