...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	53a50513          	addi	a0,a0,1338 # 800568 <main+0x44>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	53850513          	addi	a0,a0,1336 # 800588 <main+0x64>
...
exit(int error_code) {
  ...
  8000b4:	4e050513          	addi	a0,a0,1248 # 800590 <main+0x6c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800196:	41678793          	addi	a5,a5,1046 # 8005a8 <main+0x84>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	4e6a8a93          	addi	s5,s5,1254 # 8006d0 <main+0x1ac>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800410:	41c78793          	addi	a5,a5,1052 # 800828 <error_string>
  ...
  800424:	1b860613          	addi	a2,a2,440 # 8005d8 <main+0xb4>
  ...
  800436:	19660613          	addi	a2,a2,406 # 8005c8 <main+0xa4>
  ...
  8004a8:	11dd8d93          	addi	s11,s11,285 # 8005c1 <main+0x9d>
  ...
  8004e4:	0e050513          	addi	a0,a0,224 # 8005c0 <main+0x9c>
  ...
  8004f8:	0ccd8d93          	addi	s11,s11,204 # 8005c0 <main+0x9c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800528:	adc72703          	lw	a4,-1316(a4) # 801000 <zero>
main(void) {
  80052c:	1141                	addi	sp,sp,-16
  80052e:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  800530:	0017079b          	addiw	a5,a4,1
  800534:	0037b793          	sltiu	a5,a5,3
  800538:	0007059b          	sext.w	a1,a4
  80053c:	e391                	bnez	a5,800540 <main+0x1c>
  80053e:	4581                	li	a1,0
  800540:	00000517          	auipc	a0,0x0
  800544:	16050513          	addi	a0,a0,352 # 8006a0 <main+0x17c>
  800548:	bb5ff0ef          	jal	8000fc <cprintf>
    panic("FAIL: T.T\n");
  80054c:	00000617          	auipc	a2,0x0
  800550:	16460613          	addi	a2,a2,356 # 8006b0 <main+0x18c>
  800554:	45a5                	li	a1,9
  800556:	00000517          	auipc	a0,0x0
  80055a:	16a50513          	addi	a0,a0,362 # 8006c0 <main+0x19c>
  80055e:	ac3ff0ef          	jal	800020 <__panic>
