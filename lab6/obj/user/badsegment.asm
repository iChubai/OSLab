...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	51250513          	addi	a0,a0,1298 # 800540 <main+0x1c>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	51050513          	addi	a0,a0,1296 # 800560 <main+0x3c>
...
exit(int error_code) {
  ...
  8000b4:	4b850513          	addi	a0,a0,1208 # 800568 <main+0x44>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800196:	3ee78793          	addi	a5,a5,1006 # 800580 <main+0x5c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	4b2a8a93          	addi	s5,s5,1202 # 80069c <main+0x178>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800410:	3ec78793          	addi	a5,a5,1004 # 8007f8 <error_string>
  ...
  800424:	19060613          	addi	a2,a2,400 # 8005b0 <main+0x8c>
  ...
  800436:	16e60613          	addi	a2,a2,366 # 8005a0 <main+0x7c>
  ...
  8004a8:	0f5d8d93          	addi	s11,s11,245 # 800599 <main+0x75>
  ...
  8004e4:	0b850513          	addi	a0,a0,184 # 800598 <main+0x74>
  ...
  8004f8:	0a4d8d93          	addi	s11,s11,164 # 800598 <main+0x74>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800538:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  80053a:	ae7ff0ef          	jal	800020 <__panic>
