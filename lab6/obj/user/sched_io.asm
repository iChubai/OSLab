...
obj/__user_sched_io.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000aa:	59a50513          	addi	a0,a0,1434 # 800640 <main+0x130>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	4da78793          	addi	a5,a5,1242 # 800658 <main+0x148>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	5e6a8a93          	addi	s5,s5,1510 # 8007bc <main+0x2ac>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003fc:	52078793          	addi	a5,a5,1312 # 800918 <error_string>
  ...
  800410:	28460613          	addi	a2,a2,644 # 800690 <main+0x180>
  ...
  800422:	26260613          	addi	a2,a2,610 # 800680 <main+0x170>
  ...
  800494:	1e1d8d93          	addi	s11,s11,481 # 800671 <main+0x161>
  ...
  8004d0:	1a450513          	addi	a0,a0,420 # 800670 <main+0x160>
  ...
  8004e4:	190d8d93          	addi	s11,s11,400 # 800670 <main+0x160>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void)
{
  800510:	7175                	addi	sp,sp,-144
  800512:	e122                	sd	s0,128(sp)
  800514:	fca6                	sd	s1,120(sp)
  800516:	f8ca                	sd	s2,112(sp)
  800518:	f4ce                	sd	s3,104(sp)
  80051a:	f0d2                	sd	s4,96(sp)
  80051c:	e506                	sd	ra,136(sp)
  80051e:	1800                	addi	s0,sp,48
  ...
  800554:	25850513          	addi	a0,a0,600 # 8007a8 <main+0x298>
  800558:	b91ff0ef          	jal	8000e8 <cprintf>
    return 0;
}
  80055c:	60aa                	ld	ra,136(sp)
  80055e:	640a                	ld	s0,128(sp)
  800560:	74e6                	ld	s1,120(sp)
  800562:	7946                	ld	s2,112(sp)
  800564:	79a6                	ld	s3,104(sp)
  800566:	7a06                	ld	s4,96(sp)
  800568:	4501                	li	a0,0
  80056a:	6149                	addi	sp,sp,144
  80056c:	8082                	ret
            sched_set_burst(5, 5);
  80056e:	4595                	li	a1,5
  800570:	ec2a                	sd	a0,24(sp)
  800572:	852e                	mv	a0,a1
  800574:	ecd6                	sd	s5,88(sp)
  800576:	e8da                	sd	s6,80(sp)
  800578:	e4de                	sd	s7,72(sp)
  80057a:	b4bff0ef          	jal	8000c4 <sched_set_burst>
            sched_set_nice(nice_vals[i]);
  80057e:	048a                	slli	s1,s1,0x2
  800580:	00000797          	auipc	a5,0x0
  800584:	47078793          	addi	a5,a5,1136 # 8009f0 <nice_vals>
  800588:	97a6                	add	a5,a5,s1
  80058a:	439c                	lw	a5,0(a5)
            int loops = 0;
  80058c:	4901                	li	s2,0
    for (i = 0; i < 200; i++)
  80058e:	0c800413          	li	s0,200
            sched_set_nice(nice_vals[i]);
  800592:	853e                	mv	a0,a5
  800594:	8abe                	mv	s5,a5
  800596:	b31ff0ef          	jal	8000c6 <sched_set_nice>
            lab6_setpriority(prio_vals[i]);
  80059a:	00000797          	auipc	a5,0x0
  80059e:	44678793          	addi	a5,a5,1094 # 8009e0 <prio_vals>
  8005a2:	97a6                	add	a5,a5,s1
  8005a4:	439c                	lw	a5,0(a5)
            while ((gettime_msec() - t0) < DURATION_MS)
  8005a6:	4af00493          	li	s1,1199
            lab6_setpriority(prio_vals[i]);
  8005aa:	853e                	mv	a0,a5
  8005ac:	8b3e                	mv	s6,a5
  8005ae:	b11ff0ef          	jal	8000be <lab6_setpriority>
            uint32_t first = gettime_msec();
  8005b2:	b0bff0ef          	jal	8000bc <gettime_msec>
  8005b6:	8baa                	mv	s7,a0
            int cpu_start = sched_get_runtime();
  8005b8:	b11ff0ef          	jal	8000c8 <sched_get_runtime>
            while ((gettime_msec() - t0) < DURATION_MS)
  8005bc:	68e2                	ld	a7,24(sp)
            int cpu_start = sched_get_runtime();
  8005be:	89aa                	mv	s3,a0
            while ((gettime_msec() - t0) < DURATION_MS)
  8005c0:	ec46                	sd	a7,24(sp)
  8005c2:	afbff0ef          	jal	8000bc <gettime_msec>
  8005c6:	414507bb          	subw	a5,a0,s4
  8005ca:	68e2                	ld	a7,24(sp)
  8005cc:	02f4e063          	bltu	s1,a5,8005ec <main+0xdc>
    volatile int j = 0;
  8005d0:	d602                	sw	zero,44(sp)
    for (i = 0; i < 200; i++)
  8005d2:	4781                	li	a5,0
        j += i;
  8005d4:	5732                	lw	a4,44(sp)
  8005d6:	9f3d                	addw	a4,a4,a5
  8005d8:	d63a                	sw	a4,44(sp)
    for (i = 0; i < 200; i++)
  8005da:	2785                	addiw	a5,a5,1
  8005dc:	fe879ce3          	bne	a5,s0,8005d4 <main+0xc4>
  8005e0:	ec46                	sd	a7,24(sp)
                yield();
  8005e2:	ad7ff0ef          	jal	8000b8 <yield>
  8005e6:	68e2                	ld	a7,24(sp)
                loops++;
  8005e8:	2905                	addiw	s2,s2,1
                yield();
  8005ea:	bfd9                	j	8005c0 <main+0xb0>
            int cpu_used = sched_get_runtime() - cpu_start;
  8005ec:	addff0ef          	jal	8000c8 <sched_get_runtime>
  8005f0:	413509bb          	subw	s3,a0,s3
            uint32_t end = gettime_msec();
  8005f4:	ac9ff0ef          	jal	8000bc <gettime_msec>
            uint32_t resp = (first - t0) / 10;
  8005f8:	4729                	li	a4,10
            uint32_t turn = (end - t0) / 10;
  8005fa:	4145043b          	subw	s0,a0,s4
  8005fe:	02e4543b          	divuw	s0,s0,a4
            uint32_t resp = (first - t0) / 10;
  800602:	414b84bb          	subw	s1,s7,s4
            if (wait < 0)
  800606:	68e2                	ld	a7,24(sp)
            int wait = (int)turn - cpu_used;
  800608:	413407bb          	subw	a5,s0,s3
            uint32_t resp = (first - t0) / 10;
  80060c:	02e4d4bb          	divuw	s1,s1,a4
            if (wait < 0)
  800610:	0007c363          	bltz	a5,800616 <main+0x106>
            int wait = (int)turn - cpu_used;
  800614:	88be                	mv	a7,a5
            cprintf("[sched_io] pid=%d nice=%d prio=%u resp=%u turn=%u cpu=%d wait=%d loops=%d\n",
  800616:	ec46                	sd	a7,24(sp)
  800618:	aa3ff0ef          	jal	8000ba <getpid>
  80061c:	68e2                	ld	a7,24(sp)
  80061e:	85aa                	mv	a1,a0
  800620:	e04a                	sd	s2,0(sp)
  800622:	87a2                	mv	a5,s0
  800624:	8726                	mv	a4,s1
  800626:	86da                	mv	a3,s6
  800628:	8656                	mv	a2,s5
  80062a:	884e                	mv	a6,s3
  80062c:	00000517          	auipc	a0,0x0
  800630:	12c50513          	addi	a0,a0,300 # 800758 <main+0x248>
  800634:	ab5ff0ef          	jal	8000e8 <cprintf>
            exit(cpu_used);
  800638:	854e                	mv	a0,s3
  80063a:	a65ff0ef          	jal	80009e <exit>
