...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	52a50513          	addi	a0,a0,1322 # 800558 <main+0x32>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	52850513          	addi	a0,a0,1320 # 800578 <main+0x52>
...
exit(int error_code) {
  ...
  8000b6:	4ce50513          	addi	a0,a0,1230 # 800580 <main+0x5a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800198:	40478793          	addi	a5,a5,1028 # 800598 <main+0x72>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f0:	4eca8a93          	addi	s5,s5,1260 # 8006d8 <main+0x1b2>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800412:	42278793          	addi	a5,a5,1058 # 800830 <error_string>
  ...
  800426:	1a660613          	addi	a2,a2,422 # 8005c8 <main+0xa2>
  ...
  800438:	18460613          	addi	a2,a2,388 # 8005b8 <main+0x92>
  ...
  8004aa:	10bd8d93          	addi	s11,s11,267 # 8005b1 <main+0x8b>
  ...
  8004e6:	0ce50513          	addi	a0,a0,206 # 8005b0 <main+0x8a>
  ...
  8004fa:	0bad8d93          	addi	s11,s11,186 # 8005b0 <main+0x8a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800538:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80053a:	bc5ff0ef          	jal	8000fe <cprintf>
    panic("FAIL: T.T\n");
  ...
  800550:	ad1ff0ef          	jal	800020 <__panic>
