...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800034:	5b050513          	addi	a0,a0,1456 # 8005e0 <main+0x82>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	5b050513          	addi	a0,a0,1456 # 800600 <main+0xa2>
...
exit(int error_code) {
  ...
  8000c0:	54c50513          	addi	a0,a0,1356 # 800608 <main+0xaa>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001ae:	47678793          	addi	a5,a5,1142 # 800620 <main+0xc2>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80020a:	44ea8a93          	addi	s5,s5,1102 # 800654 <main+0xf6>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800212:	662b8b93          	addi	s7,s7,1634 # 800870 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800468:	1ec60613          	addi	a2,a2,492 # 800650 <main+0xf2>
  ...
  80047a:	1ca60613          	addi	a2,a2,458 # 800640 <main+0xe2>
  ...
  80048c:	1b040413          	addi	s0,s0,432 # 800638 <main+0xda>
  ...
  800516:	12640413          	addi	s0,s0,294 # 800638 <main+0xda>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80052c:	111a0a13          	addi	s4,s4,273 # 800639 <main+0xdb>
...
int main(void) {
  ...
  800560:	e022                	sd	s0,0(sp)
  800562:	e406                	sd	ra,8(sp)
    int *p = (int *)0x1000;
    *p = 1;
  800564:	6405                	lui	s0,0x1
  800566:	4785                	li	a5,1
  800568:	c01c                	sw	a5,0(s0)
    int pid = fork();
  80056a:	b61ff0ef          	jal	ra,8000ca <fork>
    if (pid == 0) {
  80056e:	c51d                	beqz	a0,80059c <main+0x3e>
    ...
    assert(pid > 0);
  800570:	04a05963          	blez	a0,8005c2 <main+0x64>
    wait();
  800574:	b59ff0ef          	jal	ra,8000cc <wait>
    cprintf("[cow] parent after child write: %d\n", *p);
  800578:	400c                	lw	a1,0(s0)
  80057a:	00000517          	auipc	a0,0x0
  80057e:	42e50513          	addi	a0,a0,1070 # 8009a8 <error_string+0x138>
  800582:	b91ff0ef          	jal	ra,800112 <cprintf>
    cprintf("[cow] pass\n");
  800586:	00000517          	auipc	a0,0x0
  80058a:	44a50513          	addi	a0,a0,1098 # 8009d0 <error_string+0x160>
  80058e:	b85ff0ef          	jal	ra,800112 <cprintf>
    return 0;
}
  800592:	60a2                	ld	ra,8(sp)
  800594:	6402                	ld	s0,0(sp)
  800596:	4501                	li	a0,0
  800598:	0141                	addi	sp,sp,16
  80059a:	8082                	ret
        cprintf("[cow] child before write: %d\n", *p);
  80059c:	400c                	lw	a1,0(s0)
  80059e:	00000517          	auipc	a0,0x0
  8005a2:	39a50513          	addi	a0,a0,922 # 800938 <error_string+0xc8>
  8005a6:	b6dff0ef          	jal	ra,800112 <cprintf>
        *p = 2;
  8005aa:	4789                	li	a5,2
  8005ac:	c01c                	sw	a5,0(s0)
        cprintf("[cow] child after write: %d\n", *p);
  8005ae:	4589                	li	a1,2
  8005b0:	00000517          	auipc	a0,0x0
  8005b4:	3a850513          	addi	a0,a0,936 # 800958 <error_string+0xe8>
  8005b8:	b5bff0ef          	jal	ra,800112 <cprintf>
        exit(0);
  8005bc:	4501                	li	a0,0
  8005be:	af7ff0ef          	jal	ra,8000b4 <exit>
    assert(pid > 0);
  8005c2:	00000697          	auipc	a3,0x0
  8005c6:	3b668693          	addi	a3,a3,950 # 800978 <error_string+0x108>
  8005ca:	00000617          	auipc	a2,0x0
  8005ce:	3b660613          	addi	a2,a2,950 # 800980 <error_string+0x110>
  8005d2:	45b9                	li	a1,14
  8005d4:	00000517          	auipc	a0,0x0
  8005d8:	3c450513          	addi	a0,a0,964 # 800998 <error_string+0x128>
  8005dc:	a45ff0ef          	jal	ra,800020 <__panic>
