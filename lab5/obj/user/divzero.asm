...
exit(int error_code) {
  ...
  800074:	49850513          	addi	a0,a0,1176 # 800508 <main+0x44>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800136:	3ee78793          	addi	a5,a5,1006 # 800520 <main+0x5c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	4eaa8a93          	addi	s5,s5,1258 # 800674 <main+0x1b0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003b0:	42478793          	addi	a5,a5,1060 # 8007d0 <error_string>
  ...
  8003c4:	19860613          	addi	a2,a2,408 # 800558 <main+0x94>
  ...
  8003d6:	17660613          	addi	a2,a2,374 # 800548 <main+0x84>
  ...
  800448:	0f5d8d93          	addi	s11,s11,245 # 800539 <main+0x75>
  ...
  800484:	0b850513          	addi	a0,a0,184 # 800538 <main+0x74>
  ...
  800498:	0a4d8d93          	addi	s11,s11,164 # 800538 <main+0x74>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  8004ca:	15a50513          	addi	a0,a0,346 # 800620 <main+0x15c>
main(void) {
  8004ce:	e406                	sd	ra,8(sp)
    cprintf("About to divide by zero.\n");
  8004d0:	bcdff0ef          	jal	80009c <cprintf>
    asm volatile("div %0, %1, %2" : "=r"(result) : "r"(1), "r"(zero));
  8004d4:	00001797          	auipc	a5,0x1
  8004d8:	b2c7a783          	lw	a5,-1236(a5) # 801000 <zero>
  8004dc:	4585                	li	a1,1
  8004de:	02f5c5b3          	div	a1,a1,a5
    cprintf("value is %d.\n", result);
  8004e2:	00000517          	auipc	a0,0x0
  8004e6:	15e50513          	addi	a0,a0,350 # 800640 <main+0x17c>
  8004ea:	2581                	sext.w	a1,a1
  8004ec:	bb1ff0ef          	jal	80009c <cprintf>
    cprintf("Program continues after division.\n");
  8004f0:	00000517          	auipc	a0,0x0
  8004f4:	16050513          	addi	a0,a0,352 # 800650 <main+0x18c>
  8004f8:	ba5ff0ef          	jal	80009c <cprintf>
    return 0;
}
  8004fc:	60a2                	ld	ra,8(sp)
  8004fe:	4501                	li	a0,0
  800500:	0141                	addi	sp,sp,16
  800502:	8082                	ret
