...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	51250513          	addi	a0,a0,1298 # 800540 <main+0x1a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	51050513          	addi	a0,a0,1296 # 800560 <main+0x3a>
...
exit(int error_code) {
  ...
  8000b6:	4b650513          	addi	a0,a0,1206 # 800568 <main+0x42>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800198:	3ec78793          	addi	a5,a5,1004 # 800580 <main+0x5a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f0:	4b0a8a93          	addi	s5,s5,1200 # 80069c <main+0x176>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800412:	3ea78793          	addi	a5,a5,1002 # 8007f8 <error_string>
  ...
  800426:	18e60613          	addi	a2,a2,398 # 8005b0 <main+0x8a>
  ...
  800438:	16c60613          	addi	a2,a2,364 # 8005a0 <main+0x7a>
  ...
  8004aa:	0f3d8d93          	addi	s11,s11,243 # 800599 <main+0x73>
  ...
  8004e6:	0b650513          	addi	a0,a0,182 # 800598 <main+0x72>
  ...
  8004fa:	0a2d8d93          	addi	s11,s11,162 # 800598 <main+0x72>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  80053a:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  80053c:	ae5ff0ef          	jal	800020 <__panic>
