...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	62a50513          	addi	a0,a0,1578 # 800658 <main+0x116>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800054:	62850513          	addi	a0,a0,1576 # 800678 <main+0x136>
...
exit(int error_code) {
  ...
  8000c6:	5be50513          	addi	a0,a0,1470 # 800680 <main+0x13e>
  8000ca:	050000ef          	jal	80011a <cprintf>
    while (1);
...
cputch(int c, int *cnt) {
  ...
  8000e6:	e42e                	sd	a1,8(sp)
    sys_putc(c);
  8000e8:	fcdff0ef          	jal	8000b4 <sys_putc>
    (*cnt) ++;
...
umain(void) {
  ...
  800152:	3f0000ef          	jal	800542 <main>
    exit(ret);
  800156:	f65ff0ef          	jal	8000ba <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001b4:	4e878793          	addi	a5,a5,1256 # 800698 <main+0x156>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80020c:	6b4a8a93          	addi	s5,s5,1716 # 8008bc <main+0x37a>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80042e:	5ee78793          	addi	a5,a5,1518 # 800a18 <error_string>
  ...
  800442:	28a60613          	addi	a2,a2,650 # 8006c8 <main+0x186>
  ...
  800454:	26860613          	addi	a2,a2,616 # 8006b8 <main+0x176>
  ...
  8004c6:	1efd8d93          	addi	s11,s11,495 # 8006b1 <main+0x16f>
  ...
  800502:	1b250513          	addi	a0,a0,434 # 8006b0 <main+0x16e>
  ...
  800516:	19ed8d93          	addi	s11,s11,414 # 8006b0 <main+0x16e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800550:	bcbff0ef          	jal	80011a <cprintf>
    if ((pid = fork()) == 0) {
  800554:	b7dff0ef          	jal	8000d0 <fork>
  ...
  800566:	bb5ff0ef          	jal	80011a <cprintf>
    }
    assert(pid > 0);
  ...
  800576:	ba5ff0ef          	jal	80011a <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  80057a:	006c                	addi	a1,sp,12
  80057c:	8522                	mv	a0,s0
  80057e:	b5bff0ef          	jal	8000d8 <waitpid>
  ...
  800596:	b43ff0ef          	jal	8000d8 <waitpid>
  80059a:	c529                	beqz	a0,8005e4 <main+0xa2>
  80059c:	b37ff0ef          	jal	8000d2 <wait>
  ...
  8005ac:	b6fff0ef          	jal	80011a <cprintf>
  ...
  8005e0:	a41ff0ef          	jal	800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  ...
  80061c:	a05ff0ef          	jal	800020 <__panic>
        cprintf("I am the child.\n");
  800620:	00000517          	auipc	a0,0x0
  800624:	19850513          	addi	a0,a0,408 # 8007b8 <main+0x276>
  800628:	af3ff0ef          	jal	80011a <cprintf>
        yield();
  80062c:	aafff0ef          	jal	8000da <yield>
        yield();
  800630:	aabff0ef          	jal	8000da <yield>
        yield();
  800634:	aa7ff0ef          	jal	8000da <yield>
        yield();
  800638:	aa3ff0ef          	jal	8000da <yield>
        yield();
  80063c:	a9fff0ef          	jal	8000da <yield>
        yield();
  800640:	a9bff0ef          	jal	8000da <yield>
        yield();
  800644:	a97ff0ef          	jal	8000da <yield>
        exit(magic);
  800648:	00001517          	auipc	a0,0x1
  80064c:	9b852503          	lw	a0,-1608(a0) # 801000 <magic>
  800650:	a6bff0ef          	jal	8000ba <exit>
