...
000000000080006c <sys_pgdir>:
}

int
sys_pgdir(void) {
    return syscall(SYS_pgdir);
  80006c:	457d                	li	a0,31
...
exit(int error_code) {
  ...
  80007c:	48850513          	addi	a0,a0,1160 # 800500 <main+0x30>
...
getpid(void) {
    return sys_getpid();
  800086:	bff1                	j	800062 <sys_getpid>

0000000000800088 <print_pgdir>:
}
...
print_pgdir(void) {
    sys_pgdir();
  800088:	b7d5                	j	80006c <sys_pgdir>
...
cputch(int c, int *cnt) {
  ...
  800094:	e42e                	sd	a1,8(sp)
    sys_putc(c);
  800096:	fd1ff0ef          	jal	800066 <sys_putc>
    (*cnt) ++;
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800142:	3da78793          	addi	a5,a5,986 # 800518 <main+0x48>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80019a:	4aaa8a93          	addi	s5,s5,1194 # 800640 <main+0x170>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003bc:	3e078793          	addi	a5,a5,992 # 800798 <error_string>
  ...
  8003d0:	18460613          	addi	a2,a2,388 # 800550 <main+0x80>
  ...
  8003e2:	16260613          	addi	a2,a2,354 # 800540 <main+0x70>
  ...
  800454:	0e1d8d93          	addi	s11,s11,225 # 800531 <main+0x61>
  ...
  800490:	0a450513          	addi	a0,a0,164 # 800530 <main+0x60>
  ...
  8004a4:	090d8d93          	addi	s11,s11,144 # 800530 <main+0x60>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
